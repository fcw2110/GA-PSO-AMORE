...
i=i+1;
Rnames{i} = 'ISOP + O3 = 0.6540273*OH + 0.010238522*HO2 + 0.280917538*CH3OO + 1.795166622*CH3CO3 + 0.378081763*MACP + 0.075751134*H2O2 + 0.162821948*CO + 2.0*HCHO + 0.222329477*MACR + 0.269065*MVK + 1.971189537*ORA1 + 1.986277378*OLT';
k(:,i) = 1.58E-14.*exp(-2000./T);
Gstr{i,1} = 'ISOP'; Gstr{i,2} = 'O3'; 
fISOP(i)=fISOP(i)-1.0; fO3(i)=fO3(i)-1.0; fOH(i)=fOH(i)+0.6540273; fHO2(i)=fHO2(i)+0.010238522; fCH3OO(i)=fCH3OO(i)+0.280917538; fCH3CO3(i)=fCH3CO3(i)+1.795166622; fMACP(i)=fMACP(i)+0.378081763; fH2O2(i)=fH2O2(i)+0.075751134; fCO(i)=fCO(i)+0.162821948; fHCHO(i)=fHCHO(i)+2.0; fMACR(i)=fMACR(i)+0.222329477; fMVK(i)=fMVK(i)+0.269065; fORA1(i)=fORA1(i)+1.971189537; fOLT(i)=fOLT(i)+1.986277378; 


i=i+1;
Rnames{i} = 'ISOP + NO3 = 1.336037351*INO2 + 1.216480913*IHN + 1.906492703*HCHO + 1.740958564*NO2 + 1.532032676*MVK + 0.403214395*MACR';
k(:,i) = 2.95E-12.*exp(-450./T);
Gstr{i,1} = 'ISOP'; Gstr{i,2} = 'NO3'; 
fISOP(i)=fISOP(i)-1.0; fNO3(i)=fNO3(i)-1.0; fINO2(i)=fINO2(i)+1.336037351; fIHN(i)=fIHN(i)+1.216480913; fHCHO(i)=fHCHO(i)+1.906492703; fNO2(i)=fNO2(i)+1.740958564; fMVK(i)=fMVK(i)+1.532032676; fMACR(i)=fMACR(i)+0.403214395; 


i=i+1;
Rnames{i} = 'ISOP + OH = 0.555662079*ISOPOO + 0.131320495*HCHO + 0.159726584*MACR + 0.035686389*MGLY + 1.839057212*CO + 0.07035477*CH3CO3';
k(:,i) = 2.69E-11.*exp(390./T);
Gstr{i,1} = 'ISOP'; Gstr{i,2} = 'OH'; 
fISOP(i)=fISOP(i)-1.0; fOH(i)=fOH(i)-1.0; fISOPOO(i)=fISOPOO(i)+0.555662079; fHCHO(i)=fHCHO(i)+0.131320495; fMACR(i)=fMACR(i)+0.159726584; fMGLY(i)=fMGLY(i)+0.035686389; fCO(i)=fCO(i)+1.839057212; fCH3CO3(i)=fCH3CO3(i)+0.07035477; 


i=i+1;
Rnames{i} = 'ISOPOO + CH3OO = 1.069181109*HO2 + 1.95068734*HCHO + 1.525119683*MACR + 0.513803898*MVK + 0.746409217*MOH + 1.894094384*ROH + 0.01248041*ALD + 0.039481027*GLYX + 1.435792202*HKET';
k(:,i) = 3.4E-12.*exp(221./T);
Gstr{i,1} = 'ISOPOO'; Gstr{i,2} = 'CH3OO'; 
fISOPOO(i)=fISOPOO(i)-1.0; fCH3OO(i)=fCH3OO(i)-1.0; fHO2(i)=fHO2(i)+1.069181109; fHCHO(i)=fHCHO(i)+1.95068734; fMACR(i)=fMACR(i)+1.525119683; fMVK(i)=fMVK(i)+0.513803898; fMOH(i)=fMOH(i)+0.746409217; fROH(i)=fROH(i)+1.894094384; fALD(i)=fALD(i)+0.01248041; fGLYX(i)=fGLYX(i)+0.039481027; fHKET(i)=fHKET(i)+1.435792202; 


i=i+1;
Rnames{i} = 'ISOPOO + CH3CO3 = 1.153909626*HO2 + 1.264987796*HCHO + 1.917992514*GLYX + 0.285010007*MVK + 1.784960461*ORA2';
k(:,i) = 2.49E-11;
Gstr{i,1} = 'ISOPOO'; Gstr{i,2} = 'CH3CO3'; 
fISOPOO(i)=fISOPOO(i)-1.0; fCH3CO3(i)=fCH3CO3(i)-1.0; fHO2(i)=fHO2(i)+1.153909626; fHCHO(i)=fHCHO(i)+1.264987796; fGLYX(i)=fGLYX(i)+1.917992514; fMVK(i)=fMVK(i)+0.285010007; fORA2(i)=fORA2(i)+1.784960461; 
...
i=i+1;
Rnames{i} = 'ISOPOO + NO = 0.21639976*IHN + 1.1759951*HCHO + 1.674699728*HO2 + 1.15409409*NO2 + 0.01*MACR + 0.431672831*MVK';
k(:,i) = 6E-12.*exp(350./T);
Gstr{i,1} = 'ISOPOO'; Gstr{i,2} = 'NO'; 
fISOPOO(i)=fISOPOO(i)-1.0; fNO(i)=fNO(i)-1.0; fIHN(i)=fIHN(i)+0.21639976; fHCHO(i)=fHCHO(i)+1.1759951; fHO2(i)=fHO2(i)+1.674699728; fNO2(i)=fNO2(i)+1.15409409; fMACR(i)=fMACR(i)+0.01; fMVK(i)=fMVK(i)+0.431672831; 
...
k(:,i) = 3.14E-11.*exp(580./T);
Gstr{i,1} = 'INO2'; Gstr{i,2} = 'HO2'; 
fINO2(i)=fINO2(i)-1.0; fHO2(i)=fHO2(i)-1.0; fISOPN(i)=fISOPN(i)+0.821941504; fOH(i)=fOH(i)+0.232901434; 


i=i+1;
Rnames{i} = 'INO2 + NO = 0.048073184*MVK + 0.026563978*ISOPN + 0.253924806*IHN + 0.073190795*HCHO + 1.534826303*NO2';
k(:,i) = 9.42E-12.*exp(580./T);
Gstr{i,1} = 'INO2'; Gstr{i,2} = 'NO'; 
fINO2(i)=fINO2(i)-1.0; fNO(i)=fNO(i)-1.0; fMVK(i)=fMVK(i)+0.048073184; fISOPN(i)=fISOPN(i)+0.026563978; fIHN(i)=fIHN(i)+0.253924806; fHCHO(i)=fHCHO(i)+0.073190795; fNO2(i)=fNO2(i)+1.534826303; 
