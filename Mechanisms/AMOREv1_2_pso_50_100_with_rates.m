...
i=i+1;
Rnames{i} = 'ISOP + O3 = 0.892068944*OH + 0.010062619*HO2 + 0.425188137*CH3OO + 0.013554027*CH3CO3 + 1.269265832*MACP + 0.187958034*H2O2 + 1.978423901*CO + 1.10856841*HCHO + 0.283832794*MACR + 0.01*MVK + 0.937111992*ORA1 + 0.897488758*OLT';
k(:,i) = 66.19329418*1.58E-14.*exp(-2000./T);
Gstr{i,1} = 'ISOP'; Gstr{i,2} = 'O3'; 
fISOP(i)=fISOP(i)-1.0; fO3(i)=fO3(i)-1.0; fOH(i)=fOH(i)+0.892068944; fHO2(i)=fHO2(i)+0.010062619; fCH3OO(i)=fCH3OO(i)+0.425188137; fCH3CO3(i)=fCH3CO3(i)+0.013554027; fMACP(i)=fMACP(i)+1.269265832; fH2O2(i)=fH2O2(i)+0.187958034; fCO(i)=fCO(i)+1.978423901; fHCHO(i)=fHCHO(i)+1.10856841; fMACR(i)=fMACR(i)+0.283832794; fMVK(i)=fMVK(i)+0.01; fORA1(i)=fORA1(i)+0.937111992; fOLT(i)=fOLT(i)+0.897488758; 


i=i+1;
Rnames{i} = 'ISOP + NO3 = 1.074837138*INO2 + 0.01*IHN + 0.19439388*HCHO + 1.310669918*NO2 + 0.85637284*MVK + 0.110438694*MACR';
k(:,i) = 70.30773719*2.95E-12.*exp(-450./T);
Gstr{i,1} = 'ISOP'; Gstr{i,2} = 'NO3'; 
fISOP(i)=fISOP(i)-1.0; fNO3(i)=fNO3(i)-1.0; fINO2(i)=fINO2(i)+1.074837138; fIHN(i)=fIHN(i)+0.01; fHCHO(i)=fHCHO(i)+0.19439388; fNO2(i)=fNO2(i)+1.310669918; fMVK(i)=fMVK(i)+0.85637284; fMACR(i)=fMACR(i)+0.110438694; 


i=i+1;
Rnames{i} = 'ISOP + OH = 0.534097457*ISOPOO + 0.139716168*HCHO + 0.046387082*MACR + 0.034327755*MGLY + 0.61485058*CO + 0.084732587*CH3CO3';
k(:,i) = 99.99738946*2.69E-11.*exp(390./T);
Gstr{i,1} = 'ISOP'; Gstr{i,2} = 'OH'; 
fISOP(i)=fISOP(i)-1.0; fOH(i)=fOH(i)-1.0; fISOPOO(i)=fISOPOO(i)+0.534097457; fHCHO(i)=fHCHO(i)+0.139716168; fMACR(i)=fMACR(i)+0.046387082; fMGLY(i)=fMGLY(i)+0.034327755; fCO(i)=fCO(i)+0.61485058; fCH3CO3(i)=fCH3CO3(i)+0.084732587; 


i=i+1;
Rnames{i} = 'ISOPOO + CH3OO = 0.381789989*HO2 + 1.886756259*HCHO + 1.91827477*MACR + 1.79360843*MVK + 0.060541538*MOH + 0.241026111*ROH + 1.337554695*ALD + 1.963155851*GLYX + 1.408638151*HKET';
k(:,i) = 81.09117163*3.4E-12.*exp(221./T);
Gstr{i,1} = 'ISOPOO'; Gstr{i,2} = 'CH3OO'; 
fISOPOO(i)=fISOPOO(i)-1.0; fCH3OO(i)=fCH3OO(i)-1.0; fHO2(i)=fHO2(i)+0.381789989; fHCHO(i)=fHCHO(i)+1.886756259; fMACR(i)=fMACR(i)+1.91827477; fMVK(i)=fMVK(i)+1.79360843; fMOH(i)=fMOH(i)+0.060541538; fROH(i)=fROH(i)+0.241026111; fALD(i)=fALD(i)+1.337554695; fGLYX(i)=fGLYX(i)+1.963155851; fHKET(i)=fHKET(i)+1.408638151; 


i=i+1;
Rnames{i} = 'ISOPOO + CH3CO3 = 0.27269448*HO2 + 0.015442951*HCHO + 0.586265973*GLYX + 1.677309803*MVK + 1.674680718*ORA2';
k(:,i) = 56.30318318*2.49E-11;
Gstr{i,1} = 'ISOPOO'; Gstr{i,2} = 'CH3CO3'; 
fISOPOO(i)=fISOPOO(i)-1.0; fCH3CO3(i)=fCH3CO3(i)-1.0; fHO2(i)=fHO2(i)+0.27269448; fHCHO(i)=fHCHO(i)+0.015442951; fGLYX(i)=fGLYX(i)+0.586265973; fMVK(i)=fMVK(i)+1.677309803; fORA2(i)=fORA2(i)+1.674680718; 


i=i+1;
Rnames{i} = 'ISOPOO + HO2 = 0.302031962*ISOPOOH + 1.714288598*HO2';
k(:,i) = 98.52332961*4.5E-13.*exp(1300./T);
Gstr{i,1} = 'ISOPOO'; Gstr{i,2} = 'HO2'; 
fISOPOO(i)=fISOPOO(i)-1.0; fHO2(i)=fHO2(i)-1.0; fISOPOOH(i)=fISOPOOH(i)+0.302031962; fHO2(i)=fHO2(i)+1.714288598; 


i=i+1;
Rnames{i} = 'ISOPOO + NO = 0.120168451*IHN + 1.382663326*HCHO + 1.834544199*HO2 + 1.080603672*NO2 + 0.207915541*MACR + 0.769050538*MVK';
k(:,i) = 99.72411302*6E-12.*exp(350./T);
Gstr{i,1} = 'ISOPOO'; Gstr{i,2} = 'NO'; 
fISOPOO(i)=fISOPOO(i)-1.0; fNO(i)=fNO(i)-1.0; fIHN(i)=fIHN(i)+0.120168451; fHCHO(i)=fHCHO(i)+1.382663326; fHO2(i)=fHO2(i)+1.834544199; fNO2(i)=fNO2(i)+1.080603672; fMACR(i)=fMACR(i)+0.207915541; fMVK(i)=fMVK(i)+0.769050538; 


i=i+1;
Rnames{i} = 'ISOPOOH + OH = 1.08692194*ISOPOO';
k(:,i) = 75.2656328*4.6E-12.*exp(200./T);
Gstr{i,1} = 'ISOPOOH'; Gstr{i,2} = 'OH'; 
fISOPOOH(i)=fISOPOOH(i)-1.0; fOH(i)=fOH(i)-1.0; fISOPOO(i)=fISOPOO(i)+1.08692194; 


i=i+1;
Rnames{i} = 'INO2 + HO2 = 1.14925815*ISOPN + 1.733571286*OH';
k(:,i) = 67.73666913*3.14E-11.*exp(580./T);
Gstr{i,1} = 'INO2'; Gstr{i,2} = 'HO2'; 
fINO2(i)=fINO2(i)-1.0; fHO2(i)=fHO2(i)-1.0; fISOPN(i)=fISOPN(i)+1.14925815; fOH(i)=fOH(i)+1.733571286; 


i=i+1;
Rnames{i} = 'INO2 + NO = 0.275469824*MVK + 0.060738274*ISOPN + 1.011015772*IHN + 0.079532094*HCHO + 1.655513456*NO2';
k(:,i) = 44.96618462*9.42E-12.*exp(580./T);
Gstr{i,1} = 'INO2'; Gstr{i,2} = 'NO'; 
fINO2(i)=fINO2(i)-1.0; fNO(i)=fNO(i)-1.0; fMVK(i)=fMVK(i)+0.275469824; fISOPN(i)=fISOPN(i)+0.060738274; fIHN(i)=fIHN(i)+1.011015772; fHCHO(i)=fHCHO(i)+0.079532094; fNO2(i)=fNO2(i)+1.655513456; 


i=i+1;
Rnames{i} = 'IHN + OH = 1.117520345*ISOPN + 1.718676247*IEPOX + 0.431774229*OH + 0.773755338*NO2';
k(:,i) = 24.58455798*2.4E-11.*exp(390./T);
Gstr{i,1} = 'IHN'; Gstr{i,2} = 'OH'; 
fIHN(i)=fIHN(i)-1.0; fOH(i)=fOH(i)-1.0; fISOPN(i)=fISOPN(i)+1.117520345; fIEPOX(i)=fIEPOX(i)+1.718676247; fOH(i)=fOH(i)+0.431774229; fNO2(i)=fNO2(i)+0.773755338; 


i=i+1;
Rnames{i} = 'IHN = 0.047971939*HNO3';
k(:,i) = 92.61923828*4E-5;
Gstr{i,1} = 'IHN'; 
fIHN(i)=fIHN(i)-1.0; fHNO3(i)=fHNO3(i)+0.047971939; 


i=i+1;
Rnames{i} = 'ISOPOOH + OH = 1.191108387*MGLY + 1.783993934*MACR + 0.213736299*GLYX + 1.08691523*MVK + 1.985059014*IEPOX + 1.755618889*CH3CO3 + 1.885677139*OH + 1.694407438*HO2 + 0.030745105*ROCN2OXY8';
k(:,i) = 68.96048186*2.97E-11.*exp(390./T);
Gstr{i,1} = 'ISOPOOH'; Gstr{i,2} = 'OH'; 
fISOPOOH(i)=fISOPOOH(i)-1.0; fOH(i)=fOH(i)-1.0; fMGLY(i)=fMGLY(i)+1.191108387; fMACR(i)=fMACR(i)+1.783993934; fGLYX(i)=fGLYX(i)+0.213736299; fMVK(i)=fMVK(i)+1.08691523; fIEPOX(i)=fIEPOX(i)+1.985059014; fCH3CO3(i)=fCH3CO3(i)+1.755618889; fOH(i)=fOH(i)+1.885677139; fHO2(i)=fHO2(i)+1.694407438; fROCN2OXY8(i)=fROCN2OXY8(i)+0.030745105; 


i=i+1;
Rnames{i} = 'ROCN2OXY8 + OH = 1.772571274*MACR + 1.303252737*MVK';
k(:,i) = 76.43397206*3E-12;
Gstr{i,1} = 'ROCN2OXY8'; Gstr{i,2} = 'OH'; 
fROCN2OXY8(i)=fROCN2OXY8(i)-1.0; fOH(i)=fOH(i)-1.0; fMACR(i)=fMACR(i)+1.772571274; fMVK(i)=fMVK(i)+1.303252737; 
